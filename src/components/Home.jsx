  ...
  return (
    <div className='header-content'>
        <div className='left-header'>
            ...
            <div className="image">
                <img src="src\assets\img\herophoto.png"alt="image" />
            </div>
        </div>
      ...
      <a href="https://drive.google.com/file/d/19zKwoFSwqdaxAr8ZbDd_pSgK4r6DWXpV/view?usp=sharing" className='main-btn'>
